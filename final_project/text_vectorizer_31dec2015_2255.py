...
for name in data_dict:
  ...
  #  poi_data.append((data_point['poi'],name))
    ...
    if data_point['email_address'] == 'NaN':
                        ...
                        for line in email_records:
                            ...
                            with open(line, "r") as text:
                                ...
                                for key, value in msg.items():
                                    if key == 'To':
                                        if value in poiEmails():   # condition for the email to be send to poi
     ...
     # i need to put all emails from the same person in to one email
     # merg = ' '.join([ls[i] for i in range(len(ls))])
                
                
pickle.dump( word_data, open("to_poi_email_data.pkl", "w") )
#pickle.dump( poi_data, open("to_poi_email_labels.pkl", "w") )                
            
            
# lets make a script to look just at the poi_to_poi vs poi_to_any emails
# for that i'll use poi_email_address.py              
